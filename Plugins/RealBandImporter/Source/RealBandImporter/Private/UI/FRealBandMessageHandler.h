...
*/
class FRealBandMessageHandler : public FGenericApplicationMessageHandler
{
	
public:

	FRealBandMessageHandler(const TSharedPtr<FGenericApplicationMessageHandler>& InTargetHandler);

	FRealBandMessageHandler();

	virtual ~FRealBandMessageHandler();
